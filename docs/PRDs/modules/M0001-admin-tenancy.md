...
|           8 | [M0001-05: Authorization](M0001-admin-tenancy/M0001-05-authorization.md)                                                         | Grant root authority from `is_root`; role seeds and assignments moved to M0569.                           | `platform_roles`                                               | Complete | Root authority implemented in PR #11; role seeds, assignments, and non-root resolution moved to M0569.                 |
