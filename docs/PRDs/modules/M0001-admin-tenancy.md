...
initial central identity. WU 5 defines role seeds and assignment behavior. WU 6
finalizes the root assignment after provisioning runs those seeds. Tenant
selection then uses sessions, memberships, and platform-role assignments. PRD
identifiers remain fixed when work is reordered.
...
|           4 | [M0001-12: Administrative events](M0001-admin-tenancy/M0001-12-administrative-events.md)                                         | Define the event catalogue and implement validated append and authorized read operations.                 | `managed_events`                                               | Not started |                                                                                                            |
|           5 | [M0001-04: Session management](M0001-admin-tenancy/M0001-04-session-management.md)                                               | Create, resolve, rotate, expire, and revoke authenticated sessions.                                       | `sessions`                                                     | Not started |                                                                                                            |
...
|           7 | [M0001-02: Root-user provisioning](M0001-admin-tenancy/M0001-02-root-user-provisioning.md)                                       | Create the configured owning tenant, root portal user, and root membership.                               | `tenants`, `portal_users`, `portal_user_tenants`               | Not started |                                                                                                            |
|           8 | [M0001-05: Authorization](M0001-admin-tenancy/M0001-05-authorization.md)                                                         | Define all-tenant and owner-only role seed scripts; assign any valid tenant-local role to portal users.   | `platform_roles`                                               | Not started |                                                                                                            |
|           9 | [M0001-06: Cell management](M0001-admin-tenancy/M0001-06-cell-management.md)                                                     | Register cells, track provisioning, and finalize the root assignment after owning-tenant role seeding.    | `cells`, `cell_provisioning`                                   | Not started |                                                                                                            |
