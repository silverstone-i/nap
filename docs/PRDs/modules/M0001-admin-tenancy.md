...
capability resolution are deferred to M0003 (role seeds) and I0005
(assignments and non-root resolution). WU 6 manages
cells independently of root authority. Tenant selection then uses sessions,
memberships, root authority, and platform-role assignments (I0005). PRD identifiers
...
|           8 | [M0001-05: Authorization](M0001-admin-tenancy/M0001-05-authorization.md)                                                         | Grant root authority from `is_root`; role seeds moved to M0003, assignments to I0005.                     | `platform_roles`                                               | Complete | Root authority implemented in PR #11; role seeds, assignments, and non-root resolution moved to M0003 and I0005.       |
