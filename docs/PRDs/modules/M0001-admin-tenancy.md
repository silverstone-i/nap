...
The table gives the planned start order. Unit 0 creates all admin tables and
models. Units 1–12 implement record access, APIs, and business rules. Establish the cache and event contracts
early, then integrate them as each operation is built. Units 11 and 12 are
...
assignments. PRD identifiers remain fixed when work is reordered.

| Start order | Work unit / PRD                                                                                                                  | Required work                                                                                                                                | Tables                                                         | Status      | Blocker / evidence |
| ----------: | -------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------- | ----------- | ------------------ |
|           1 | [M0001-00: Admin database foundation](M0001-admin-tenancy/M0001-00-admin-database-foundation.md)                                 | Define all tables and schema objects; implement models, setup, migrations, grants, and database policies.                                    | All 13 admin tables                                            | Not started |                    |
...
|           5 | [M0001-05: Authorization](M0001-admin-tenancy/M0001-05-authorization.md)                                                         | Seed the three immutable system-role definitions and their capabilities; allow multiple `platform_admin` and `support` assignments per user. | `system_roles`, `platform_roles`                               | Not started |                    |
...
|           7 | [M0001-02: Root-user provisioning](M0001-admin-tenancy/M0001-02-root-user-provisioning.md)                                       | Create the Napsoft tenant, root portal user, and root membership safely and repeatably.                                                      | `tenants`, `portal_users`, `portal_user_tenants`               | Not started |                    |
