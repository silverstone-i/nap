...
| ----------: | -------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------- | -------- | ---------------------------------------------------------------------------------------------------------------------- |
|           1 | [M0001-00: Admin database foundation](M0001-admin-tenancy/M0001-00-admin-database-foundation.md)                                 | Define all tables and schema objects; implement models, setup, migrations, grants, and database policies.         | All 13 admin tables                                            | Complete | [Verified 2026-09-19](M0001-admin-tenancy/M0001-00-admin-database-foundation.md#verification-evidence)                 |
...
|          14 | [M0001-13: Support access consent](M0001-admin-tenancy/M0001-13-support-access-consent.md)                                       | Request and record user consent before support acts as a tenant member; read-only support and break-glass writes. | `support_grants`, `sessions`                                   | Blocked  | Postponed until admin tenancy and cell tenancy run with RBAC; schema delivered in M0001-00.                            |
...
including their required cache and event integration. M0001-13 is postponed
until admin tenancy and cell tenancy run with RBAC, and does not hold that completion. Cell integration is verified separately.
