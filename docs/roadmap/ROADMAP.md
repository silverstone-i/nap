...
|     6 | Cell provisioning               | `I0003: Cell Provisioning`               | Cell registration, progress, failure, retry, and disable actions                  | Complete    | [I0003](../PRDs/inter-module-workflows/I0003-cell-provisioning.md), [silverstone-i/nap#30](https://github.com/silverstone-i/nap/pull/30)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
|     7 | Tenant provisioning             |                                          | Tenant creation, progress, failure, and retry                                     | Not started |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
|     8 | Projection synchronization      | `I0004: Admin-Cell Sync`                 | Synchronization state and actionable failures in both directions (cell ↔ admin)   | In progress | [I0004](../PRDs/inter-module-workflows/I0004-admin-cell-sync.md); sync delivery built, synchronization state screen not started                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
...
| Order | Deliverable                | PRD | UI increment                                                   | Status      | Evidence |
| ----: | -------------------------- | --- | -------------------------------------------------------------- | ----------- | -------- |
|     9 | Tenant access-control data |     | Role, permission, assignment, and access-scope administration  | Not started |          |
|    10 | RBAC decision model        |     | Permission-aware routes, navigation, actions, and denied state | Not started |          |
...
- M0569 role seeds, assignments, and non-root authorization require cell
