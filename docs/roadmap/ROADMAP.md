...
|    10 | RBAC decision model        | `I0005: RBAC Decision Model` | Permission-aware routes, navigation, actions, and denied state | Not started |          |
