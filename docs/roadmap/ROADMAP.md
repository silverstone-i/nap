...
and verification evidence. It covers the modules, capabilities, workflows, and UI
...
|     4 | Cell tenancy                    | `M0002: Cell Tenancy`                      | None; cell readiness and shell context is a separate future feature             | Complete    | [M0002-01](../PRDs/modules/M0002-cell-tenancy/M0002-01-cell-database-foundation.md#verification-evidence), [M0002-02](../PRDs/modules/M0002-cell-tenancy/M0002-02-physical-identity.md#verification-evidence)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
|     4 | Runtime cell registry           | `W0001: Runtime Cell Registry And Routing` | Tenant selection succeeds for tenants in a ready cell                           | Not started |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
|     5 | Cell provisioning               |                                            | Cell registration, progress, failure, retry, and disable actions                | Not started |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
|     6 | Tenant provisioning             |                                            | Tenant creation, progress, failure, and retry                                   | Not started |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
|     7 | Projection synchronization      |                                            | Synchronization state and actionable failures in both directions (cell ↔ admin) | Not started |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
...
| 2026-09-24 | Cell tenancy                    | M0002-02 implemented; RLS removed from `cell` tables; later work moved to workflows; family complete | [Physical identity verification](../PRDs/modules/M0002-cell-tenancy/M0002-02-physical-identity.md#verification-evidence)                                                  |

## Current Blockers

- M0569 role seeds, assignments, and non-root authorization require cell
  provisioning (5), tenant provisioning (6), and tenant access-control data (9).
