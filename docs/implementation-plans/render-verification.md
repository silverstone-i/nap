...
## Production automation evidence — 2026-09-14

[PR #28](https://github.com/silverstone-i/nap/pull/28), released as v0.19.1, automated temporary operator access and configuration publication and corrected database ownership SQL. All 524 local tests and repository checks passed. Live admin setup, migration and bootstrap completed, and reruns preserved root credentials and records. Temporary access rules were removed. The deployed `nap-verification` service returned 200 for both health endpoints; its login page was visually inspected, and root login was verified through the Management HTTP API.
