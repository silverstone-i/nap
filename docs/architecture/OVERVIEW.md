...
| ----------------- | -------------------------- | ------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Auth              | Authentication             | Defined | [PRD 0004](../PRDs/0004-authentication-and-session-management.md); ADRs [0004](../ADRs/0004-portal-user-login-and-tenant-selection.md), [0014](../ADRs/0014-session-tokens-and-lifetimes.md), [0015](../ADRs/0015-password-credential-storage.md) |
