...
| ----------------- | -------------------------- | ------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Auth              | Authentication             | Partial | [PRD 0004](../PRDs/0004-authentication-and-session-management.md); ADRs [0004](../ADRs/0004-portal-user-login-and-tenant-selection.md), [0014](../ADRs/0014-session-tokens-and-lifetimes.md), [0015](../ADRs/0015-password-credential-storage.md); [RULES/auth-module.md](../RULES/auth-module.md) |
...
| Core              | Data persistence           | Defined | [PRD 0005](../PRDs/0005-data-persistence.md); [ADR-0016](../ADRs/0016-continuous-data-persistence.md)                                                                                                                                                                                              |
