...
required checks pass; do not mark partial delivery Verified.

When such documents exist, include the final status and evidence in the PR
branch. Verified requires merged code and passing CI; do not describe unmerged
