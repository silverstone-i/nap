...
7. Read the repo's applicable AGENTS.md and CLAUDE.md for check commands and release rules.
   If Git has not been initialized yet, report that the ship workflow is unavailable and stop.
