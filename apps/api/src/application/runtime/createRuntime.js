 ...
 * @param {{admin: import('pg-schemata').Database, cells?: {connect: () => Promise<void>, close: () => Promise<void>}, cache?: {close: () => Promise<void>}}} handles
    ...
    stopping = (async () => {
      ...
      await new Promise(resolve => {
        ...
        Promise.all([
          ...
          Promise.resolve().then(() => handles.cells?.close()),
