...
const CATALOG_ENTRIES = [
  ...
  { module: 'core', router: 'vendors', action: null, label: 'Vendors', description: 'Vendor company records', sort_order: 110 },
  { module: 'core', router: 'clients', action: null, label: 'Clients', description: 'Client company records', sort_order: 120 },
  { module: 'core', router: 'employees', action: null, label: 'Employees', description: 'Employee records', sort_order: 130 },
  { module: 'core', router: 'contacts', action: null, label: 'Contacts', description: 'Miscellaneous contacts / payees', sort_order: 140 },
  { module: 'core', router: 'sources', action: null, label: 'Sources', description: 'Polymorphic source registry', sort_order: 150 },
  { module: 'core', router: 'addresses', action: null, label: 'Addresses', description: 'Addresses linked to entities', sort_order: 160 },
  { module: 'core', router: 'phone-numbers', action: null, label: 'Phone Numbers', description: 'Phone numbers linked to entities', sort_order: 170 },
  { module: 'core', router: 'inter-companies', action: null, label: 'Inter-Companies', description: 'Internal company entities for intercompany accounting', sort_order: 180 },
  { module: 'core', router: 'roles', action: null, label: 'Roles', description: 'RBAC role definitions', sort_order: 190 },
  { module: 'core', router: 'policies', action: null, label: 'Policies', description: 'Permission grants per role', sort_order: 200 },
  ...
  { module: 'core', router: 'state-filters', action: null, label: 'State Filters', description: 'Layer 3 status visibility filters', sort_order: 220 },
  { module: 'core', router: 'field-group-definitions', action: null, label: 'Field Group Definitions', description: 'Layer 4 named column groups', sort_order: 230 },
  ...
  { module: 'bom', router: 'catalog-skus', action: null, label: 'Catalog SKUs', description: 'Internal product catalog', sort_order: 610 },
  { module: 'bom', router: 'vendor-skus', action: null, label: 'Vendor SKUs', description: 'Vendor-submitted SKU descriptions with embeddings', sort_order: 620 },
  { module: 'bom', router: 'vendor-pricing', action: null, label: 'Vendor Pricing', description: 'Price history per vendor SKU', sort_order: 630 },
