...
import policyCatalogAvailableFields from './202503050014_policyCatalogAvailableFields.js';

export default [coreRbac, coreEntities, numberingSystem, policyCatalogValidStatuses, policyCatalogAvailableFields];
