...
/**
 * Get the access token secret (lazy, avoids config import at module load).
 */
...
/**
 * Get the refresh token secret (lazy, avoids config import at module load).
 */
 ...
 * Claims: sub, ph (permission hash), iss, aud
