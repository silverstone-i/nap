...
export default function ClientsPage() {
  ...
  return (
    <Box sx={pageContainerSx}>
      ...
      <ConfirmDialog open={archiveOpen} title="Archive Client" message={selected ? `Archive "${selected.name}"?` : ''} confirmLabel="Archive" confirmColor="error" loading={archiveMut.isPending} onConfirm={handleArchive} onCancel={() => setArchiveOpen(false)} />
      <ConfirmDialog open={restoreOpen} title="Restore Client" message={selected ? `Restore "${selected.name}"?` : ''} confirmLabel="Restore" confirmColor="success" loading={restoreMut.isPending} onConfirm={handleRestore} onCancel={() => setRestoreOpen(false)} />
